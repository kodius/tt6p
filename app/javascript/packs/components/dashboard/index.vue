<template>
  <layout>
    ...
    <div v-if="loadedBodyMass">
      <measurement-chart :height="300" :labels="labels" :datasets="bodyMassDatasets" :datasets1="leanBodyMassDatasets" label="Weight(kg)" label1="Lean Body Mass(kg)" backgroundColor="#698E8B" stepSize=10 backgroundColor1="#9ED2BA"></measurement-chart>
    </div>
    <div v-if="!isLoading">
      <br>
